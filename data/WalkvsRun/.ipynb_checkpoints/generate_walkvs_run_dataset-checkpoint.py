...
walkvs_run_dataset = r""

''' Load train set '''
data_dict = loadmat(walkvs_run_dataset + "WalkvsRun.mat")
...
np.save(walkvs_run_dataset + 'X_train.npy', X_train)
np.save(walkvs_run_dataset + 'y_train.npy', y_train)
np.save(walkvs_run_dataset + 'X_test.npy', X_test)
np.save(walkvs_run_dataset + 'y_test.npy', y_test)
